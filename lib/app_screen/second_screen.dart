...
class SecondScreen extends StatefulWidget {
  ...
  const SecondScreen({super.key}); // กำหนดชื่อให้ route
...
class _SecondScreen extends State<SecondScreen> {
    ...
    Widget _buildRow(context, favoriteWord, index) {
        bool alreadyFavorite = _favorite.contains(favoriteWord[index]);
        return Container(
            child: Column(
                children: <Widget>[
                    ListTile(
    ...
    Future<void> _showYourChoice(context, arg) async{ 
